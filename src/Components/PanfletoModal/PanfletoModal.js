                      ...
                      >
                        ...
                        >
                          ...
                          <Box mb={2}>
                            ...
                            <Typography variant="h6" fontWeight="700" color="#212121" sx={{ mb: 0.5 }}>
                              {produto.nome}
                            </Typography>

                            <Typography variant="body1" fontWeight="700" color="#4caf50" sx={{ fontSize: '1.3rem' }}>
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      <IconButton onClick={() => removerItem(item)} sx={{ color: '#1976d2' }} aria-label={`Remover um ${item.nome}`}>
                        <RemoveCircleOutlineIcon />
                      </IconButton>
                      <Typography sx={{ mx: 1, minWidth: 20, textAlign: 'center', fontWeight: '600' }}>
                        {item.quantidade}
                      </Typography>
                      <IconButton onClick={() => aumentarQuantidade(item)} sx={{ color: '#1976d2' }} aria-label={`Adicionar um ${item.nome}`}>
